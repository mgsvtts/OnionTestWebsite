...
public interface IOrderRepository
{
    ...
    public Task<IEnumerable<Order>> GetAllWithExactlySameNumberAsync(string number, CancellationToken token = default);

    public Task<IEnumerable<Order>> GetAllContainsNumberAsync(string number, CancellationToken token = default);
